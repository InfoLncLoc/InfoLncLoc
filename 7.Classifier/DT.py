...
def gbdt_modle(filename):
    ...
    for train_index, test_index in kf.split(data, label):
        ...
        model = DecisionTreeClassifier(criterion='entropy', max_depth=9, min_samples_leaf=33, min_samples_split=2, random_state=66)
...
if __name__ == '__main__':
    ...
    asso_1['sp'] = sp_all
    asso_1['sn'] = sn_all
    asso_1.to_csv('./DTscore_train.csv', index=False)
