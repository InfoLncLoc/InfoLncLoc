...
def gbdt_modle(filename):
    ...
    for train_index, test_index in kf.split(data, label):
        ...
        model = RandomForestClassifier(n_estimators=60, max_depth=13, min_samples_split=70, min_samples_leaf=20, oob_score=True, random_state=10, max_features=5)
...
if __name__ == '__main__':
    ...
    asso_1['sp'] = sp_all
    asso_1['sn'] = sn_all
    asso_1.to_csv('./RFscore_train.csv', index=False)
